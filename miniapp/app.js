...
const translations = {
  en: {
    ...
    refCopy: "Share your referral link. Later, invited players will bring you bonuses when they register and play.",
    copyRef: "Copy Link",
    copied: "Copied",
  ...
  ru: {
    ...
    refCopy: "Поделись реферальной ссылкой. Позже приглашенные игроки будут приносить бонусы за регистрацию и активность.",
